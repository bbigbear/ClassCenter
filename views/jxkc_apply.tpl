...
<form class="layui-form layui-form-pane1" action="">
  ...
  <div class="layui-inline">
    ...
    <div class="layui-input-inline" style="width: 100px;">
      <select name="style" id="style" lay-filter="status_select">
		    <option value="全部" > 课程类别</option>
			<option value="生效" > 必修</option>
			<option value="终止" > 选修</option>
      </select>
    </div>
  </div>
  <div class="layui-inline">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
		...
		<button class="layui-btn" id="clear">清楚条件</button>
		<button class="layui-btn" id="add">新建课程</button>
  	</div>
  </div>
</form>
