  ...
  ,element=layui.element;
	...
	$(function(){
		[<range .m>]
			...
			$("#EndTime").val([<.EndTime>])
			$("#TeacherEnable").val([<.TeacherEnable>])
			$("#StudentEnable").val([<.StudentEnable>])
			//$("#TeacherEnable option:contains('[<.TeacherEnable>]')").prop("selected", true);
			//$("#TeacherEnable option[value='启动']").prop("selected", "selected");
		[<end>]
	})
	laydate.render({
	    elem: '#StartTime'
